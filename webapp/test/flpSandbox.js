					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sorting, Grouping and filtering ",
									"targetURL": "#list2-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"list2-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=list2",
									"url": sap.ui.require.toUrl("list2")
								}
							}
						}
					}
